...
local lGuns = {
	...
	--sound = {["active"] = {id = "gun_fire", repeating = "true", time = 0.7}, },
	bulletTexture= {["dormant"] = "bullet", ["active"] = "bullet"},
	shootingBehaviour = firingBehaviour({pos = vector(19.6, 3.3) * levelAttribs.blockSize, vel = vector(-1.0, 0), timeLastBullet = 1.5, timeBetweenBullets = 1.5}, newFire, newReset, newSoundReady),
	state = "dormant"},
	...
	sound = {["active"] = {id = "gun_fire", repeating = "true", time = 0.7}, },
	bulletTexture= {["dormant"] = "bullet", ["active"] = "bullet"},
	shootingBehaviour = firingBehaviour({pos = vector(24.3, 9) * levelAttribs.blockSize, vel = vector(0, 1.5), timeLastBullet = 0.7, timeBetweenBullets = 0.7}, newFire, newReset, newSoundReady),
	state = "dormant"},
...
local lEnemies = {
		...
		speed = levelAttribs.jailerSpeed/2,
		...
		pos = vector(5.1,  27),
		category = "jailer_melee",
		speed = levelAttribs.jailerSpeed/3,
		texture = {["dormant"] = "meleejailer", ["attacking_path"] = "meleejailer_flash", ["attacking_direct"] = "meleejailer_red", ["dead"] = "meleejailer_death" },
		sound = {["attacking_path"] = {id = "jailer_pathingbeep", repeating = "true", time = 1}, ["attacking_direct"] = {id = "jailer_pathingbeep", repeating = "true", time = 0.5},
			["dead"] = {id = "jailer_death", repeating = "false", time = 0.1}},
